...
def decrypt(key, ciphertext):
    ...
    cipher_matrix = add_round_key(cipher_matrix, round_keys.pop())

    for i in range(N_ROUNDS - 1, 0, -1):
        inv_shift_rows(cipher_matrix)
        cipher_matrix = sub_bytes(cipher_matrix, inv_s_box)
        cipher_matrix = add_round_key(cipher_matrix, round_keys.pop())
    ...
    plaintext = bytes(sum(cipher_matrix, []))
